  ...
  build: {
    rollupOptions: {
      input: {
        ...
        chatbotYaptirmak: resolve(__dirname, 'chatbot-yaptirmak.html'),
        ...
        faturaOkuma: resolve(__dirname, 'fatura-okuma.html'),
        eTicaretSitesiYaptirmak: resolve(__dirname, 'e-ticaret-sitesi-yaptirmak.html'),
        eFaturaEntegrasyonu: resolve(__dirname, 'e-fatura-entegrasyonu.html'),
