  ...
  build: {
    rollupOptions: {
      input: {
        ...
        ozelYazilimYaptirmak: resolve(__dirname, 'ozel-yazilim-yaptirmak.html'),
        whatsappChatbotYaptirmak: resolve(__dirname, 'whatsapp-chatbot-yaptirmak.html'),
        webSitesiYaptirmakAnkara: resolve(__dirname, 'web-sitesi-yaptirmak-ankara.html'),
        mobilUygulamaYaptirmak: resolve(__dirname, 'mobil-uygulama-yaptirmak.html'),
        logoNetsisEntegrasyon: resolve(__dirname, 'logo-netsis-entegrasyon.html'),
